...
#line 702
typedef int (*__compar_fn_t)(const void *arg_0x7f5d3d7db020, const void *arg_0x7f5d3d7db2f8);
#line 740
__extension__ 
#line 757
__extension__ 
...
#line 260
extern double erfc(double arg_0x7f5d3d7589c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 343
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f5d3d5128e8), 
int (*key_eq_fn)(void *arg_0x7f5d3d5110c8, void *arg_0x7f5d3d511368));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7f5d3d30f610, int arg_0x7f5d3d30f878);
static double RandomUniform(void );
...
enum SimSchedulerBasicP$__nesc_unnamed4325 {
...
enum /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$__nesc_unnamed4329 {
...
enum /*TemperatureMonitorAppC.DemoSensorC.ConstantSensorC*/ConstantSensorC$0$__nesc_unnamed4337 {
#line 47
...
# 34 "TemperatureMonitorC.nc"
enum TemperatureMonitorC$__nesc_unnamed4338 {
#line 34
  TemperatureMonitorC$sendDataMessage = 8U
};
#line 34
typedef int TemperatureMonitorC$__nesc_sillytask_sendDataMessage[TemperatureMonitorC$sendDataMessage];
#line 58
enum TemperatureMonitorC$__nesc_unnamed4339 {
#line 58
  TemperatureMonitorC$sendSetupMessage = 9U
};
#line 58
...
#line 163
    ...
    if (len == sizeof(SETUPmsg ) && TOS_NODE_ID != 1) 
      {

        SETUPmsg *setupMsg = (SETUPmsg *)payload;

        if (TOS_NODE_ID != __nesc_ntoh_uint8(setupMsg->father.nxdata)) 
          {
            sim_log_debug(190U, "Temp", "Received from node %d the new threshold %d \n", __nesc_ntoh_uint16(setupMsg->node_id.nxdata), __nesc_ntoh_uint16(setupMsg->threshold.nxdata));
            sim_log_debug(191U, "Temp", "Setting route back to %d \n", __nesc_ntoh_uint16(setupMsg->node_id.nxdata));
...
# 78 "/usr/src/tinyos/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x7f5d3cf06340, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f5d3cf06340) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x7f5d3cf06340, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/usr/src/tinyos/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x7f5d3cf05020, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x7f5d3cf05020, msg, payload, len);
#line 78
...
#line 64
# 99 "TemperatureMonitorC.nc"
static inline void TemperatureMonitorC$AMControl$startDone(error_t err)
#line 99
{
  if (err == SUCCESS) {
      sim_log_debug(184U, "Temp", "Node %d started\n", TOS_NODE_ID);
      TemperatureMonitorC$TimerMeasureTemperature$startPeriodic(600);
      TemperatureMonitorC$TimerGenerateNewThreshold$startPeriodic(1300);
    }
  else 
#line 104
    {
...
# 110 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x7f5d3cf07220, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x7f5d3cf07220, msg, error);
#line 110
}
#line 110
...
# 100 "/usr/src/tinyos/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x7f5d3ca78e18, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f5d3ca78e18) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x7f5d3ca78e18, msg, error);
#line 100
      break;
#line 100
    }
...
#line 146
{
  ...
  if (result == SUCCESS) {
      ...
      sim_log_debug(188U, "Temp", "Temperature found : %u \n", TemperatureMonitorC$temperature[sim_node()]);
...
#line 34
{
  ...
  if (TemperatureMonitorC$busy[sim_node()]) 
    {
      sim_log_debug(180U, "Temp", "I'm busy!\n");
      return;
    }

  msg = (DATAmsg *)TemperatureMonitorC$Packet$getPayload(&TemperatureMonitorC$pkt[sim_node()], sizeof(DATAmsg ));
  if (msg == (void *)0) {
#line 44
    return;
    }
#line 45
  ...
  sim_log_debug(181U, "Temp", "Sending DATA msg: sender %d , measured value %d \n", __nesc_ntoh_uint16(msg->sender.nxdata), __nesc_ntoh_uint16(msg->temperature.nxdata));
  if (TemperatureMonitorC$AMSend$send(TemperatureMonitorC$routeBackNode[sim_node()], &TemperatureMonitorC$pkt[sim_node()], sizeof(DATAmsg )) == SUCCESS) {
...
static inline void TemperatureMonitorC$sendSetupMessage$runTask(void )
{
  ...
  if (TemperatureMonitorC$busy[sim_node()]) 
    {
      sim_log_debug(182U, "Temp", "I'm busy!\n");
      return;
    }

  msg = (SETUPmsg *)TemperatureMonitorC$Packet$getPayload(&TemperatureMonitorC$pkt[sim_node()], sizeof(SETUPmsg ));
  if (msg == (void *)0) {
#line 69
    return;
    }
#line 70
  ...
  sim_log_debug(183U, "Temp", "Sending SETUP msg: threshold = %d \n", __nesc_ntoh_uint16(msg->threshold.nxdata));

  if (TemperatureMonitorC$AMSend$send(AM_BROADCAST_ADDR, &TemperatureMonitorC$pkt[sim_node()], sizeof(SETUPmsg )) == SUCCESS) {
...
# 75 "/usr/src/tinyos/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x7f5d3d1ffab0){
#line 75
  switch (arg_0x7f5d3d1ffab0) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x7f5d3d1ffab0);
#line 75
      break;
#line 75
    }
...
#line 162
# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x7f5d3ca76020, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x7f5d3ca76020, addr, msg, len);
#line 80
...
#line 132
{
  ...
  if (TOS_NODE_ID != 1) {
      ...
      sim_log_debug(187U, "Temp", "Temperature found : %u \n", TemperatureMonitorC$temperature[sim_node()]);
...
# 83 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x7f5d3cb132f8){
#line 83
  switch (arg_0x7f5d3cb132f8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x7f5d3cb132f8);
#line 83
      break;
#line 83
    }
